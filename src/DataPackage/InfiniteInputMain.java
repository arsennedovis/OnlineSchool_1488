    ...
    public static void main(String[] args) {
        while (true) {
            ...
            public static String scanKeyOrValue (String outputText){
                 ...
                 * на вході в функцію змінюєм isErrorInScanFn змінюється на помилку до моменту її
            ...
            public static Boolean isThatKeyFoundInData (String keyItem){
                 ...
                 * Ще не вмію повертати два ретурни з 1 ф-ції, тому реалізовано
                 * через глобальну змінну.
                 */
                for (int i = 0; i < dualDataArray.length; i++) {
                    if (keyItem.equals(dualDataArray[i][0])) {
                        keyFoundedIndex = i;
                        return true;
                    }
                }
            ...
            public static int searchFirstEmptyPlaceInArray() {
                 ...
                 * буде встроєний тригер для копіювання масиву з більшим контейнером.
                 */
                for (int i = 0; i < dualDataArray.length; i++) {
        ...
        /*
        Спочатку зчитується введеня потенційного ключа з клавіатури.
        Викунується перевірка на наявність такого в масиві, якщо існує
